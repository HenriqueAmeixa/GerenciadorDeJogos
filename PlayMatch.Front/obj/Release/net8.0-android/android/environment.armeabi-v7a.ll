...
@dso_cache = dso_local local_unnamed_addr global [706 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 314315057, ; hash 0x12bc1131, from name: PlayMatch.Front.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 619435444, ; hash 0x24ebd5b4, from name: libaot-PlayMatch.Front.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PlayMatch.Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 90
	...
	%struct.DSOCacheEntry {
		i64 642638914, ; hash 0x264de442, from name: PlayMatch.Core.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 699723061, ; hash 0x29b4ed35, from name: aot-PlayMatch.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PlayMatch.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 106
	...
	%struct.DSOCacheEntry {
		i64 742569241, ; hash 0x2c42b519, from name: aot-PlayMatch.Front
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PlayMatch.Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 109
	...
	%struct.DSOCacheEntry {
		i64 2045599965, ; hash 0x79ed60dd, from name: libaot-PlayMatch.Front
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PlayMatch.Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 326
	...
	%struct.DSOCacheEntry {
		i64 2381440034, ; hash 0x8df1e422, from name: libaot-PlayMatch.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PlayMatch.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 392
	...
	%struct.DSOCacheEntry {
		i64 2433216141, ; hash 0x9107ee8d, from name: aot-PlayMatch.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PlayMatch.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 401
	...
	%struct.DSOCacheEntry {
		i64 2965815448, ; hash 0xb0c6c098, from name: libaot-PlayMatch.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PlayMatch.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 492
	...
	%struct.DSOCacheEntry {
		i64 3485074729, ; hash 0xcfba0529, from name: PlayMatch.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PlayMatch.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 579
	...
	%struct.DSOCacheEntry {
		i64 3954944222, ; hash 0xebbba8de, from name: aot-PlayMatch.Front.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PlayMatch.Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 652
	...
	%struct.DSOCacheEntry {
		i64 4099395768, ; hash 0xf457d0b8, from name: PlayMatch.Front
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PlayMatch.Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 671
