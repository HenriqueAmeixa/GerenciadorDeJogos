...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555173, ; uint32_t android_runtime_jnienv_class_token (0x20002e5)
	i32 100670916, ; uint32_t jnienv_initialize_method_token (0x6001dc4)
	i32 100670915, ; uint32_t jnienv_registerjninatives_method_token (0x6001dc3)
...
@dso_cache = dso_local local_unnamed_addr global [706 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 116061035524587125, ; hash 0x19c54e59ab4fe75, from name: aot-PlayMatch.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PlayMatch.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 232682425412790833, ; hash 0x33aa76ee034aa31, from name: libaot-PlayMatch.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PlayMatch.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 9
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.68_name, ; name: libaot-Xamarin.Google.UserMessagingPlatform.dll.so
		ptr null; void* handle (0x0)
	}, ; 18
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.34_name, ; name: libaot-Plugin.MauiMtAdmob.dll.so
		ptr null; void* handle (0x0)
	}, ; 20
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.99_name, ; name: libaot-System.Reflection.Emit.dll.so
		ptr null; void* handle (0x0)
	}, ; 40
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-AutoMapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 57
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.69_name, ; name: libaot-Xamarin.GooglePlayServices.Ads.Lite.dll.so
		ptr null; void* handle (0x0)
	}, ; 177
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4874421583439811742, ; hash 0x43a56c9ab66d549e, from name: aot-PlayMatch.Front
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PlayMatch.Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 186
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7275231786765807268, ; hash 0x64f6d0c3a4ce6ea4, from name: libaot-PlayMatch.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PlayMatch.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 256
	...
	%struct.DSOCacheEntry {
		i64 8319503763650062358, ; hash 0x7374d0982be32816, from name: PlayMatch.Front.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PlayMatch.Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 306
	...
	%struct.DSOCacheEntry {
		i64 9830571143287328865, ; hash 0x886d345ec6d8d061, from name: libaot-PlayMatch.Front.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PlayMatch.Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 372
	...
	%struct.DSOCacheEntry {
		i64 12911346842679467310, ; hash 0xb32e518bd1c55d2e, from name: PlayMatch.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PlayMatch.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 512
	...
	%struct.DSOCacheEntry {
		i64 13260080134365211859, ; hash 0xb80544a0960d6cd3, from name: aot-PlayMatch.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PlayMatch.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 528
	...
	%struct.DSOCacheEntry {
		i64 15318541342546666991, ; hash 0xd49664309fa125ef, from name: PlayMatch.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PlayMatch.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 600
	...
	%struct.DSOCacheEntry {
		i64 15740442059956441976, ; hash 0xda7148a837525378, from name: aot-PlayMatch.Front.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PlayMatch.Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 620
	...
	%struct.DSOCacheEntry {
		i64 16044322695529306733, ; hash 0xdea8e27c30c31a6d, from name: libaot-PlayMatch.Front
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PlayMatch.Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 628
	...
	%struct.DSOCacheEntry {
		i64 17560908376744589910, ; hash 0xf3b4e120810afa56, from name: PlayMatch.Front
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PlayMatch.Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 672
...
@.env.3 = private unnamed_addr constant [37 x i8] c"41497abd-b50e-4b5e-a37c-4bc7a4e104a3\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [19 x i8] c"com.BeWe.PlayMatch\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [29 x i8] c"libaot-PlayMatch.Core.dll.so\00", align 16
@.DSOCacheEntry.9_name = private unnamed_addr constant [30 x i8] c"libaot-PlayMatch.Front.dll.so\00", align 16
@.DSOCacheEntry.10_name = private unnamed_addr constant [25 x i8] c"libaot-AutoMapper.dll.so\00", align 16
...
@.DSOCacheEntry.34_name = private unnamed_addr constant [33 x i8] c"libaot-Plugin.MauiMtAdmob.dll.so\00", align 16
...
@.DSOCacheEntry.68_name = private unnamed_addr constant [51 x i8] c"libaot-Xamarin.Google.UserMessagingPlatform.dll.so\00", align 16
@.DSOCacheEntry.69_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Ads.Lite.dll.so\00", align 16
...
@.DSOCacheEntry.99_name = private unnamed_addr constant [37 x i8] c"libaot-System.Reflection.Emit.dll.so\00", align 16
